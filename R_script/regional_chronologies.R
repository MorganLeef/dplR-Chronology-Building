...
cv_region_abba<-combine.rwl(list(BFT_ABBA.rwl,COR_ABBA.rwl,DRT_ABBA.rwl,FRE_ABBA.rwl,MAL_ABBA.rwl,MVT_ABBA.rwl,RMR_ABBA.rwl,SEW_ABBA.rwl,UPT_ABBA.rwl,VFD_ABBA.rwl))
...
#PCRU
cv_region_pcru<-combine.rwl(list(BFT_PCRU.rwl,COR_PCRU.rwl,DRT_PCRU.rwl,FRE_PCRU.rwl,MAL_PCRU.rwl,MVT_PCRU.rwl,RMR_PCRU.rwl,SEW_PCRU.rwl,UPT_PCRU.rwl,VFD_PCRU.rwl))
