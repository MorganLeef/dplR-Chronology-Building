...
sub_dol_abba<-subset(DOL_ABBA.crn, years_ABBA > 1950 & years_ABBA < 2017)
...
sub_dol_pcru<-subset(DOL_PCRU.crn, years_PCRU > 1950 & years_PCRU < 2017)
...
sub_bdr_abba<-subset(BDR_ABBA.crn, years_ABBA > 1950 & years_ABBA < 2017)
...
sub_bdr_pcru<-subset(BDR_PCRU.crn, years_PCRU > 1950 & years_PCRU < 2017)
...
sub_brs_abba<-subset(BRS_ABBA.crn, years_ABBA > 1950 & years_ABBA < 2017)
...
sub_brs_pcru<-subset(BRS_PCRU.crn, years_PCRU > 1950 & years_PCRU < 2017)
...
sub_msh_abba<-subset(MSH_ABBA.crn, years_ABBA > 1965 & years_ABBA < 2017)
...
sub_msh_pcru<-subset(MSH_PCRU.crn, years_PCRU > 1965 & years_PCRU < 2017)
