...
fre_p1<-ggplot(fre_rec_rot, aes(x = Year, y=mean_ngsi, colour = bwa_pop))+
  scale_color_manual(values=c("red","blue","white","white"), 
                     label=c("None","Light","",""),
                     name="")+
  geom_point()+
  geom_line()+
  ggtitle("Freeland Road BWA nGSI/Rotholz Summary")+
  ylim(-2.5,1.5)+
...
mal_p1<-ggplot(mal_rec_rot, aes(x = Year, y=mean_ngsi, colour = bwa_pop))+
  scale_color_manual(values=c("red","blue","white","white"), 
                     label=c("None","Light","",""),
                     name="")+
  geom_point()+
  geom_line()+
  ggtitle("Mallow Lake BWA nGSI/Rotholz Summary")+
  ylim(-2.5,1.5)+
  xlim(2013.67,2016.35)+
  ylab("Mean nGSI")+
  theme(legend.position="none")+
...
mvt_p1<-ggplot(mvt_rec_rot, aes(x = Year, y=mean_ngsi, colour = bwa_pop))+
  scale_color_manual(values=c("red","blue","brown","cyan"), 
                     label=c("None","Light","Moderate","Heavy"),
                     name="")+
  geom_point()+
  geom_line()+
  ggtitle("Middle Valley Trail BWA nGSI/Rotholz Summary")+
  ylim(-2.5,1.5)+
  xlim(2013.67,2016.35)+
  ylab("Mean nGSI")+
  theme(legend.position="none")+
...
sew_p1<-ggplot(sew_rec_rot, aes(x = Year, y=mean_ngsi, colour = bwa_pop))+
  scale_color_manual(values=c("red","blue","brown","white"), 
                     label=c("None","Light","Moderate",""),
                     name="")+
  geom_point()+
  geom_line()+
  ggtitle("CV Sewer Plant BWA nGSI/Rotholz Summary")+
  ylim(-2.5,1.5)+
  xlim(2013.67,2016.35)+
  ylab("Mean nGSI")+
  theme(legend.position="none")+
...
vfd_p1<-ggplot(vfd_rec_rot, aes(x = Year, y=mean_ngsi, colour = bwa_pop))+
  scale_color_manual(values=c("red","blue","white","white"), 
                     label=c("None","Light","",""),
                     name="")+
  geom_point()+
  geom_line()+
  ggtitle("CV Volunteer Fire Dept. BWA nGSI/Rotholz Summary")+
  ylim(-2.5,1.5)+
  xlim(2013.67,2016.35)+
  ylab("Mean nGSI")+
  theme(legend.position="none")+
